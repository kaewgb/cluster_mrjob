...
class PlatformDetector(object):
    ...
    def set_cuda_device(self, device_id):
        ...
        # Commented by penpornk for cluster_mrjob 
        # (allows CUDA runtime to fall back to other GPUs when GPU#0 is busy
...
class ConfigReader(object):
    ...
    def __init__(self, specializer):
        try:
	    if os.path.expanduser("~") == "/homes":
		self.stream = open("/n/shokuji/da/penpornk/.asp_config.yml")
	    else:	
